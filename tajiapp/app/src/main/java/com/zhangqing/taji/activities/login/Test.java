...
public class Test {
	...
	public void uploadForm(Map<String, String> params, String fileFormName,
		...
		Log.e("uploadFromBySocket", conn.getResponseMessage()+"|"+conn.getResponseCode());
